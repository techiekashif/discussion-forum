...
public class UserActivity {
	 ...
	 *
	 * @param userActivity: the activity history of the user who is viewing this
	 *                      question
	...
	public void deleteQuestion(UserActivity userActivity, User user) throws NumberFormatException, IOException {
		...
		if (user.getUserRole() == UserRole.ADMIN) { // the user is an admin
			...
			if ((question.getUser().getUserRole() == UserRole.USER) || user == question.getUser()) {
	...
	public void deleteReply(Question question, UserActivity userActivity, User user)
